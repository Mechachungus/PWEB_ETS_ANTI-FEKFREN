...
<body class="page-no-scroll">
    ...
    <main class="page-content">
        <section class="discover-section auth-panel">
            <h2 class="room-page-title" id="welcome-heading">
                {{-- Ambil username dari session Laravel --}}
                Welcome, {{ session('username', 'Guest') }}!
            </h2>

            <p>This is your personal dashboard. From here you can view your profile details and booking history.</p>

            {{-- Logout pakai route Laravel --}}
            <form method="POST" action="{{ route('logout') }}">
                @csrf
                <button type="submit" class="btn btn-book btn-full-width">Logout</button>
            </form>
        </section>
    </main>
